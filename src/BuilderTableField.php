...
class BuilderTableField extends BaseBuilder
{
   ...
   *
   * 'name-of the-option' => [
   *     'mandatory' => number of mandatory field,
   *     'optional' => number of optional field,
   *     'list' => ['names of the op']
   * @var array
   */
...
//    'omit' => ['mandatory' => 0, 'optional' => 0],
  ...
  private function validate() {
    ...
    if (count($types) == 0) {
      $this->log('error', 'No valid types for field "'.$this->fieldName.'"');
      return;
